...
{
    private readonly RoutingEvaluator _evaluator = new();
    ...
    public void First_matching_device_rule_wins()
    {
        ...
        var decision = _evaluator.Evaluate(config, Context(DeviceType.Ios));
    ...
    public void Falls_back_when_no_rule_matches()
    {
        ...
        var decision = _evaluator.Evaluate(config, Context(DeviceType.Desktop));
