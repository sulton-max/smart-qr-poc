...
public interface IMigrationDialect
{
    ...
    /// <param name="ct">Token to cancel the operation.</param>
    Task AcquireLockAsync(NpgsqlConnection connection, long lockId, CancellationToken ct = default);
    ...
    /// <param name="ct">Token to cancel the operation.</param>
    Task ReleaseLockAsync(NpgsqlConnection connection, long lockId, CancellationToken ct = default);
    ...
    /// <param name="ct">Token to cancel the operation.</param>
    Task EnsureHistoryTableAsync(NpgsqlConnection connection, string schemaName, string tableName, CancellationToken ct = default);
}
