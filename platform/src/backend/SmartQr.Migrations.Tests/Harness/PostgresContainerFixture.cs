...
/// <summary>Owns the single Postgres container shared by the migrator suite; each test gets a clean schema via <see cref="ResetSchemaAsync"/>.</summary>
public sealed class PostgresContainerFixture : IAsyncLifetime
{
    ...
    /// <summary>Drops and recreates the <c>public</c> schema (including <c>migration_history</c>) so each test starts clean.</summary>
