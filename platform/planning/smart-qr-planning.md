...
| `SmartQr.Migrations.Cli` (`smart-qr-migrate`) | ✅ built — `status·apply·rollback·verify·new·merge` (dev CLI over the engine); destructive verbs target-DB-guarded (`--i-understand-this-is`), exit codes 0/1/2 |
