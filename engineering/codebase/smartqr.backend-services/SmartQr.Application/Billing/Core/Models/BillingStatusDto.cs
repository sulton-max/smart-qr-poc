...
/// <summary>The caller's billing snapshot. Serves <c>GET /api/billing/me</c>.</summary>
public sealed record BillingStatusDto
{
    ...
    /// <summary>The subscription status, lower-cased to mirror Stripe; Free synthesizes <c>active</c>.</summary>
