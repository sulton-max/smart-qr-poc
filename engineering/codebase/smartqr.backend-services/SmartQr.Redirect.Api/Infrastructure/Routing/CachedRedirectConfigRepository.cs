...
// UNWIRED pending the caching backlog item — DbRedirectConfigRepository is the active non-Redis default.
public sealed class CachedRedirectConfigRepository(
    IServiceScopeFactory scopeFactory,
    IMemoryCache cache,
    RedirectSettings settings) : IRedirectConfigRepository
{
    /// <inheritdoc />
