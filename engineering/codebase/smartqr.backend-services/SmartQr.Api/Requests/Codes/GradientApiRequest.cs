...
/// <summary>Represents the foreground-gradient block of a style — a polymorphic value discriminated by the camelCase <c>type</c> (<c>"linear"</c> / <c>"radial"</c>), carrying at least two stops; replaces the solid foreground when present.</summary>
